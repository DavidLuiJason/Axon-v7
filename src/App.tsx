...
const AppContent: React.FC = () => {
  ...
  return (
    <div
      id="axon-app-root"
      className={`h-full h-[100dvh] w-full flex flex-col font-sans transition-colors duration-200 overflow-hidden ${
    ...
    >
      ...
      <div className="w-full max-w-5xl mx-auto flex-1 min-h-0 flex flex-col h-full overflow-hidden shadow-2xl relative">
        ...
        <main className="flex-1 min-h-0 flex flex-col overflow-hidden relative">
          ...
          <div className={`flex-1 min-h-0 flex flex-col overflow-hidden ${currentScreen === 'axon' ? '' : 'hidden'}`}>
            <DualPaneContainer />
          </div>
