...
export const ChatPane: React.FC = () => {
  ...
  return (
    <div id="chat-pane" className="flex flex-col h-full bg-black text-white relative overflow-hidden">
      {/* Top Chat Bar (Fixed at top of chat pane) */}
      <div
        id="chat-top-bar"
        className="h-11 border-b border-neutral-800/80 px-3.5 flex items-center justify-between bg-neutral-950/90 backdrop-blur-sm shrink-0 z-10"
      >
        {/* Model Selector Pill */}
        <button
      ...
      {showScrollToBottom && (
        <button
          ...
          className="absolute bottom-20 right-4 z-30 p-2.5 rounded-full bg-neutral-900/90 text-white border border-neutral-700 shadow-2xl backdrop-blur-md active:scale-95 hover:bg-neutral-800 transition-all flex items-center justify-center animate-in fade-in slide-in-from-bottom-2 duration-150"
        >
      ...
      <div
        id="chat-input-bar"
        className="no-swipe-gesture p-3 pb-4 sm:pb-3.5 bg-neutral-950/95 border-t border-neutral-800/80 backdrop-blur-sm shrink-0 relative z-20"
