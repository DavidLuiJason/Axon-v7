...
export const Header: React.FC<HeaderProps> = ({ onOpenMenu }) => {
  ...
  return (
    <header
      id="app-header"
      className="shrink-0 sticky top-0 z-40 h-14 bg-black/90 backdrop-blur-md border-b border-neutral-800/80 px-3 flex items-center justify-between select-none"
    >
